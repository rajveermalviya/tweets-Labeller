...
!function(a, b, c) {
    ...
    function g(a) {
        var b, c = 0;
        for (this._rules = []; b = a[c++]; )
            this._rules.push(new h(b))
    }
    function h(a) {
        this._rule = a
    }
    function i(a) {
        return this instanceof i ? (this._options = a,
        a.keywords || (this._options = {
            keywords: a
        }),
        this._promise = [],
        ...
        void this._addMediaListeners()) : new i(a)
    }
    var j = RegExp("^" + String({}.valueOf).replace(/[.*+?\^${}()|\[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$")
      ...
      , m = function() {
        ...
        function d(a) {
            ...
            m.onreadystatechange = function() {
                4 != m.readyState || 200 != m.status && 304 != m.status || (i[a] = m.responseText,
                j.shift(),
                c())
            }
            ,
      ...
      , n = {
        ...
        parse: function(a, b) {
            ...
            function m() {
                for (var a, b = []; a = g(/^(from|to|\d+%|\.\d+%|\d+\.\d+%)\s*/); )
                    b.push(a[1]),
                    g(/^,\s*/);
                return b.length ? {
                    values: b,
            ...
            return b && n._cache[b] ? n._cache[b] : (a = a.replace(/\/\*[\s\S]*?\*\//g, ""),
            n._cache[b] = f())
        },
        filter: function(a, b) {
            function c(a, b) {
            ...
            function e(a) {
                null == a.media && delete a.media,
                null == a.supports && delete a.supports,
                k.push(a)
            }
            function f(a, b) {
                if (b)
            ...
            function g(a, b) {
                for (var c, e, f, g, h = /\*/, i = 0; c = b[i++]; )
                    if (e = c.split(":"),
                    f = new RegExp("^" + d(e[0]).replace(h, ".*") + "$"),
                    g = new RegExp("^" + d(e[1]).replace(h, ".*") + "$"),
                    f.test(a.property) && g.test(a.value))
                        return !0
            }
            function h(a, c, d) {
            ...
            function j(a, b, d) {
                for (var e, f = 0; e = a[f++]; )
                    e.declarations ? h(e, b, d) || i(e, b, d) : e.rules && e.media ? j(e.rules, c(b, e.media), d) : e.rules && e.supports && j(e.rules, b, c(d, e.supports))
            }
            var k = [];
            return j(a),
            k
      ...
      , o = function() {
        ...
        function e(a) {
            var d, e, f = !1;
            return g = b.documentElement.clientWidth,
            h.test(a) && (d = "em" === RegExp.$2 ? parseFloat(RegExp.$1) * c() : parseFloat(RegExp.$1)),
            i.test(a) && (e = "em" === RegExp.$2 ? parseFloat(RegExp.$1) * c() : parseFloat(RegExp.$1)),
            d && e ? f = g >= d && e >= g : (d && g >= d && (f = !0),
            e && e >= g && (f = !0)),
            {
                matches: f,
                media: a
        ...
        var f, g, h = /\(min\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/, i = /\(max\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/, j = {};
        return {
            matchMedia: function(a) {
                return l.matchMedia ? d(a) : e(a)
            },
            clearCache: function() {
                l.nativeMatchMedia || (g = null,
                j = {})
            }
        }
    }()
      , p = function() {
        ...
        var c = function() {
            ...
            return {
                add: function(b, c, d) {
                    for (var e, f = 0; e = a[f++]; )
                        if (e.polyfill == b && e.mql === c && e.fn === d)
                            return !1;
                    c.addListener(d),
                    a.push({
                        polyfill: b,
                ...
                remove: function(b) {
                    for (var c, d = 0; c = a[d++]; )
                        c.polyfill === b && (c.mql.removeListener(c.fn),
                        a.splice(--d, 1))
                }
            }
        }()
          , d = function(b) {
            ...
            return {
                add: function(d, e) {
                    b.length || (a.addEventListener ? a.addEventListener("resize", c, !1) : a.attachEvent("onresize", c)),
                    b.push({
                        polyfill: d,
                        fn: e
                    })
            ...
            addListeners: function(a, e) {
                function f() {
                    if (l.nativeMatchMedia)
                        for (var f in h)
                            h.hasOwnProperty(f) && !function(b, d) {
                                c.add(a, b, function() {
                ...
                function g(a, b) {
                    ...
                    o.clearCache();
                    for (c in b)
                        b.hasOwnProperty(c) && (d[c] = o.matchMedia(c).matches,
                        d[c] != i[c] && e.call(a, c, o.matchMedia(c).matches));
                    i = d
                }
                ...
                !function() {
                    for (var a in h)
                        h.hasOwnProperty(a) && (i[a] = o.matchMedia(a).matches)
                }(),
                f()
            }
        }
    ...
    h.prototype.getDeclaration = function() {
        for (var a, b = {}, c = 0, d = this._rule.declarations; a = d[c++]; )
            b[a.property] = a.value;
        return b
    }
    ,
    ...
    i.prototype.doMatched = function(a) {
        return this._doMatched = a,
        this._resolve(),
        this
    }
    ,
    i.prototype.undoUnmatched = function(a) {
        return this._undoUnmatched = a,
        this._resolve(),
        this
    }
    ,
    i.prototype.getCurrentMatches = function() {
        for (var a, b, c = 0, d = []; a = this._filteredRules[c++]; )
            b = a.media && a.media.join(" and "),
            (!b || o.matchMedia(b).matches) && d.push(a);
        return new g(d)
    }
    ,
    i.prototype.destroy = function() {
        this._undoUnmatched && (this._undoUnmatched(this.getCurrentMatches()),
        p.removeListeners(this))
    }
    ,
    ...
    i.prototype._resolve = function() {
        for (var a, b = 0; a = this._promise[b]; )
            a.condition.call(this) ? (this._promise.splice(b, 1),
            a.callback.call(this)) : b++
    }
    ,
    i.prototype._getStylesheets = function() {
        var a, c, d, f, g, h, i, j = 0, l = [];
        if (this._options.include) {
            for (c = this._options.include; a = c[j++]; )
                if (d = b.getElementById(a)) {
                    ...
                    d.media && (i.media = d.media),
                    l.push(i)
                }
        } else {
            for (c = this._options.exclude,
            f = b.getElementsByTagName("link"); d = f[j++]; )
                d.rel && "stylesheet" == d.rel && "print" != d.media && k(d.href) && !e(d.id, c) && (i = {
                    href: d.href
                },
                d.media && (i.media = d.media),
                l.push(i));
            for (h = b.getElementsByTagName("style"),
            j = 0; g = h[j++]; )
                i = {
                    text: g.textContent
                },
    ...
    i.prototype._downloadStylesheets = function() {
        for (var a, b = this, c = [], d = 0; a = this._stylesheets[d++]; )
            c.push(a.href);
        m.request(c, function(a) {
            for (var c, d = 0; c = a[d]; )
                b._stylesheets[d++].text = c;
            b._resolve()
        })
    }
    ,
    i.prototype._parseStylesheets = function() {
        this._defer(function() {
            ...
            for (var a, b = 0; a = this._stylesheets[b++]; )
                a.rules = n.parse(a.text, a.url)
        })
    }
    ,
    i.prototype._filterCSSByKeywords = function() {
        this._defer(function() {
            ...
            for (var a, b, c = [], d = 0; a = this._stylesheets[d++]; )
                b = a.media,
                b && "all" != b && "screen" != b ? c.push({
                    rules: a.rules,
                    media: a.media
                }) : c = c.concat(a.rules);
    ...
    i.prototype._buildMediaQueryMap = function() {
        this._defer(function() {
            ...
            var a, b, c = 0;
            for (this._mediaQueryMap = {}; b = this._filteredRules[c++]; )
                b.media && (a = b.media.join(" and "),
                this._mediaQueryMap[a] = o.matchMedia(a))
        })
    }
    ,
    ...
    i.prototype._addMediaListeners = function() {
        this._defer(function() {
            ...
            p.addListeners(this, function(a, b) {
                for (var c, d = 0, e = [], f = []; c = this._filteredRules[d++]; )
                    c.media && c.media.join(" and ") == a && (b ? e : f).push(c);
                e.length && this._doMatched(new g(e)),
                f.length && this._undoUnmatched(new g(f))
            })
        })
    }
    ,
